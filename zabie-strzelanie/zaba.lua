...
klocek("KapeluszRondo", Vector3.new(6.318, 0.182, 4.16), Vector3.new(0, 4.47, -0.65), Color3.fromRGB(78, 50, 32), Vector3.new(-5, 0, -7))
klocek("KapeluszRondoL", Vector3.new(0.182, 0.416, 3.536), Vector3.new(-3.023, 5.022, -0.698), Color3.fromRGB(78, 50, 32), Vector3.new(-5, 0, -7))
klocek("KapeluszRondoP", Vector3.new(0.182, 0.416, 3.536), Vector3.new(3.067, 4.277, -0.633), Color3.fromRGB(78, 50, 32), Vector3.new(-5, 0, -7))
klocek("KapeluszGora", Vector3.new(2.902, 1.365, 2.288), Vector3.new(0.095, 5.253, -0.588), Color3.fromRGB(94, 60, 36), Vector3.new(-5, 0, -7))
klocek("KapeluszWgniecenie", Vector3.new(1.016, 0.13, 1.602), Vector3.new(0.177, 5.921, -0.646), Color3.fromRGB(78, 50, 32), Vector3.new(-5, 0, -7))
klocek("KapeluszPasek", Vector3.new(2.954, 0.26, 2.34), Vector3.new(0.032, 4.738, -0.543), Color3.fromRGB(27, 27, 27), Vector3.new(-5, 0, -7))
