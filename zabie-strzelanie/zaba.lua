...
klocek("KapeluszRondo", Vector3.new(6.318, 0.182, 4.16), Vector3.new(0, 4.47, -0.65), Color3.fromRGB(78, 50, 32), Vector3.new(-175, 0, 173))
klocek("KapeluszRondoL", Vector3.new(0.182, 0.416, 3.536), Vector3.new(3.023, 5.022, -0.602), Color3.fromRGB(78, 50, 32), Vector3.new(-175, 0, 173))
klocek("KapeluszRondoP", Vector3.new(0.182, 0.416, 3.536), Vector3.new(-3.067, 4.277, -0.667), Color3.fromRGB(78, 50, 32), Vector3.new(-175, 0, 173))
klocek("KapeluszGora", Vector3.new(2.902, 1.365, 2.288), Vector3.new(-0.095, 5.253, -0.712), Color3.fromRGB(94, 60, 36), Vector3.new(-175, 0, 173))
klocek("KapeluszWgniecenie", Vector3.new(1.016, 0.13, 1.602), Vector3.new(-0.177, 5.921, -0.654), Color3.fromRGB(78, 50, 32), Vector3.new(-175, 0, 173))
klocek("KapeluszPasek", Vector3.new(2.954, 0.26, 2.34), Vector3.new(-0.032, 4.738, -0.757), Color3.fromRGB(27, 27, 27), Vector3.new(-175, 0, 173))
